...
class UIPlaylistView: UIView {
    ...
    static func initWith(owner: UIView, playlist: SPTPartialPlaylist) -> UIPlaylistView {
        let view = UIPlaylistView()
        view.owner = owner
        ...
        print("Building a UIPlaylistView: \(view.playlistName) - \(view.playlistAuthor)")
        view.build()
